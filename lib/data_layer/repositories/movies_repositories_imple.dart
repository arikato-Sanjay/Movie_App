...
class MoviesRepositoriesImplementation extends MoviesRepositories {
  ...
  @override
  Future<Either<AppError, List<MovieTrailerEntities>>> getMovieTrailer(int id) async {
    try{
  ...
  @override
  Future<Either<AppError, List<MoviesModel>>> getSearchedMovie(String searchTerm) async {
    try{
